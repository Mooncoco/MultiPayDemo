...
public class PayCenterActivity extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		/* 右上角关闭按钮 */
		textViewClose = (TextView) findViewById(getResources().getIdentifier(
				"close", "id", getPackageName()));
		textViewClose.setOnClickListener(onClickListener);

		/* 支付渠道列表 */
		gridViewChannel = (GridView) findViewById(getResources().getIdentifier(
				"pay_center_channel_gridview", "id", getPackageName()));
		...
		/* 确认按钮 */
		submitButton = (Button) findViewById(getResources().getIdentifier(
				"two_btn", "id", getPackageName()));
		submitButton.setOnClickListener(onClickListener);

		/* 商品描述 */
		textViewName = (TextView) findViewById(getResources().getIdentifier(
				"one_text2", "id", getPackageName()));
		textViewName.setText("100000金币");

		/* 商品价格 */
		textViewPrice = (TextView) findViewById(getResources().getIdentifier(
				"one_text4", "id", getPackageName()));
	...
	private void initProcessDialog(Context context)
	{
		...
		progressDialog.setMessage(getResources().getString(
				R.string.pay_center_process_dialog_msg));
